...
const STOREGE_KEY = 'GLOBAL_SYS_STOREGE_KEY-1.0.0'
const STOREGE_USER = 'GLOBAL_SYS_STOREGE_USER-1.0.0'
const STOREGE_PROFILE = 'GLOBAL_SYS_STOREGE_PROFILE-1.0.0'
const STOREGE_EMAIL = 'GLOBAL_SYS_STOREGE_EMAIL-1.0.0'
const STOREGE_PROFILE_ID = 'GLOBAL_SYS_STOREGE_PROFILE_ID-1.0.0'
const STOREGE_ISADMIN = 'GLOBAL_SYS_STOREGE_ISADMIN-1.0.0'
